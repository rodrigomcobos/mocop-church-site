        ...
        <>
            <div className="p-6 my-14">
                <div className="grid grid-cols-1 lg:grid-cols-3 lg:gap-8 gap-12 items-center mx-12 max-w-full max-lg:max-w-2xl max-sm:max-w-sm">
                    <div>
                        <h2 className="text-2xl font-bold text-gray-300 uppercase mb-4">PREGAÇÕES</h2>
                        <h2 className="text-3xl max-md:text-2xl font-extrabold text-gray-800">Revisite nossa lista de pregações de Domingos passados.</h2>
                    </div>
