...
const Hero = () => {
    return (
        <>
            <div className="relative bg-gradient-to-r from-black to-yellow-900 font-[sans-serif] h-[70dvh]">
                {/* Set the image to cover the entire container */}
                <div className="absolute inset-0">
                    <img src={HeroImg} alt="Background Image" className="w-full h-[70dvh] object-cover object-top opacity-45" />
                </div>
                ...
                <section className="absolute inset-0 pt-28 mx-6 flex justify-center items-center z-10 text-center text-white">
                    <div className="flex flex-col justify-center items-center">
                        ...
                        <h1 className="text-5xl md:text-8xl font-extrabold font-seaweed mb-4 drop-shadow-md shadow-gray-950">Você é Bem Vindo Aqui</h1>
