                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 max-w-md md:max-w-none mx-auto min-h-[240px]">
                        <AnimatedCard delay={0.3}>
                            <div className="p-6 md:p-8 relative z-10 space-y-4">
                                <p className='text-bottomBar font-semibold text-sm md:text-base'>QUARTAS as 7:00PM</p>
                        ...
                        <AnimatedCard delay={0.4}>
                            <div className="p-6 md:p-8 relative z-10 space-y-4">
                                <p className='text-bottomBar font-semibold text-sm md:text-base'>SEXTAS as 7:00PM</p>
                        ...
                        <AnimatedCard delay={0.5}>
                            <div className="p-6 md:p-8 relative z-10 space-y-4">
                                <p className='text-bottomBar font-semibold text-sm md:text-base'>DOMINGOS as 6:00PM</p>
