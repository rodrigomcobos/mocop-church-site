        ...
        <>
            <div className="bg-primary py-10">
                <div className="max-w-7xl mx-auto py-8 md:py-16 px-6">
                    <h2 className="text-footer text-3xl md:text-4xl text-center font-bold mb-4">Programação da Semana</h2>
                    <p className="text-black text-center mb-10 md:mb-16 text-base md:text-md max-w-5xl mx-auto">
