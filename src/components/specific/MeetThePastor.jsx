...
const MeetThePastor = () => {
    return (
        <div className="bg-white pt-32 px-2">
            <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 px-4 gap-6">
                ...
                <div className="flex flex-col justify-center text-center md:text-center order-1 md:order-2 -mt-12 md:-mt-28 sm:-mt-32">
                    ...
                    <h2 className="text-9xl font-bold bg-gradient-to-r from-teal-500 via-orange-500 to-yellow-500 text-transparent bg-clip-text font-seaweed -mt-3">Tudo</h2>
                    <p className="mt-4 text-gray-600 text-md md:text-lg text-left">
