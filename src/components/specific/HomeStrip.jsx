...
const HomeStrip = () => {
    ...
    return (
        <>
            <div className="relative min-h-[150px] py-6 px-6 md:py-8 md:px-16 bg-gradient-to-r from-orange-100 via-orange-100 to-amber-100 font-sans overflow-hidden -mt-20 z-10 max-w-[90%] lg:max-w-[80%] mx-auto rounded-lg mb-0 md:mb-24 lg:mb-8">
