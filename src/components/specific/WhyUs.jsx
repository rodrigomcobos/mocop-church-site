    ...
    return (
        <div className="font-sans px-4 py-24">
            <h2 className="text-yellowBtnHover text-3xl md:text-4xl text-center font-bold mb-14 sm:mb-16">
                Porque participar de nossa igreja?
            </h2>
            <div ref={ref} className="grid lg:grid-cols-2 gap-20 md:gap-y-36 sm:gap-y-12 lg:max-w-6xl max-w-2xl mx-auto">
                ...
                >
                    <h2 className="text-yellowBtnHover text-2xl font-bold mb-2">
                        "Tu és a Rocha e sobre esta rocha edificarei a minha Igreja"
                    </h2>
                    ...
                    <p className="mb-4 text-md text-gray-500">
                        Ser membro de uma igreja e frequentá-la semanalmente é fundamental para quem pretende seguir ao Senhor de forma plena,
                        ou seja, fazendo e cumprindo convênios sagrados e guardando Seus mandamentos. Precisamos da igreja por muitas razões.
                    </p>

                    <p className="mb-4 text-md text-gray-500">
                        Como vemos, a igreja não é apenas um lugar físico, mas um espaço abençoado e repleto de significado, onde somos
                    ...
                    <p className="mb-4 text-md text-gray-500">
                        É neste ambiente de amor e comunhão que vivenciamos o Evangelho em sua plenitude. A igreja nos oferece a oportunidade
