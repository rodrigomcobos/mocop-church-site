            ...
            <div className="py-14 px-6 sm:px-10">
                <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
                    ...
                    <div className="lg:col-span-2">
                        ...
                        <p className="text-footer mr-0 sm:mr-14 text-sm">Junte-se a nós para descobrir como a fé em Jesus pode transformar sua vida. Através do amor e da graça de Cristo, somos capacitados a enfrentar qualquer desafio e a viver com propósito.</p>
                    </div>
                    ...
                    {/* Social Media Links */}
                    <div>
                        <h4 className="text-lg font-semibold mb-8 text-footer">Redes Sociais</h4>
