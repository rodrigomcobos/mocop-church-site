...
import HeroImg from '../../src/assets/images/churchimg40.jpg'
    ...
    return (
        <div>
            <header className="relative bg-gradient-to-r from-black to-yellow-900 h-[30dvh] sm:h-[450px]">
                ...
                <section className="absolute inset-0 pt-32 mx-6 flex justify-center items-center z-10 text-center text-white">
                    <div className="flex flex-col justify-center items-center">
                        <h1 className="text-4xl md:text-5xl mb-6 drop-shadow-md shadow-gray-950 uppercase font-bold">Planeje sua Visita</h1>
                        <h2 className="text-md md:text-2xl uppercase">É sua Primeira Vez Aqui?</h2>
                    </div>
                </section>
            </header>
            ...
            >
                ...
                <motion.section variants={itemVariants} className="mb-8">
                    <h2 className="text-2xl font-bold mb-4">Venha Como Você Está</h2>
                ...
                <motion.section variants={itemVariants} className="mb-8">
                    <h2 className="text-2xl font-bold mb-4">Traga as Crianças</h2>
